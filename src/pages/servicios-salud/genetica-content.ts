...
export const content: BaseContent[] = [
  ...
  },
  {
    ...
    <p>Te permitirá conocer la edad biológica de tu organismo frente a tu edad cronológica. Si la prueba resulta
        desfavorable, la incorporación de hábitos de vida saludables te ayudará a mejorar tu longitud telomérica y edad
        biológica en el plazo de un año.</p><br>
    <h3>Alteraciones del Sueño</h3>
    <p>Permite determinar los niveles de melatonina en saliva en diferentes momentos de la noche pudiendo detectar
        cualquier desviación respecto al nivel normal, tanto en horarios como en intensidad. Con ello, se puede observar
        si la producción de melatonina es o no suficiente para la conciliación del sueño.</p><br>
    <h3>Valoración del Estrés</h3>
    <p>Comparar los niveles de cortisol y DHEA con los valores normales, aportando información acerca de la fase de
        estrés en la que se encuentra el individuo.</p>`,
    orientation: 0,
    description_2: "",
  },
  {
  ...
  },
  {
    ...
    description_1: `<h3>Tipología de Test en Oncología:</h3>
                <p>
                    <strong>Colón.</strong> Detección precoz del cáncer de colon mediante un análisis de sangre.<br>
                    <strong>Biopsia líquida</strong> mediante secuenciación para tumores sólidos en estadios avanzados (73 genes).
                </p>
                <ul class="plan-vida-p">
                    <li><span>Análisis dirigido de mutaciones tumorales en sangre (3 genes).</span></li>
                    <li><span>Detección del cáncer de próstata.</span></li>
                </ul>
                <p><strong>Test Onco Farmacogenética</strong> del tratamiento con</p>
                <ul class="plan-vida-p">
                    <li><span>5 fluorouracilo (capecitabina).</span></li>
                    <li><span>Irinotecan.</span></li>
                    <li><span>Lapatinib.</span></li>
                    <li><span>Metrotrexato.</span></li>
                    <li><span>Tamoxifeno.</span></li>
                    <li><span>Tiopurinas.</span></li>
                    <li><span>Cisplatino.</span></li>
                </ul>`,
    orientation: 0,
    description_2: "",
  },
  ...
  },
  {
    ...
    description_1: `<h3>Test Prenatal</h3>
                <p>
                    Analiza el ADN libre fetal presente en la sangre materna para determinar el riesgo de que el feto sea portador de las anomalías cromosómicas estudiadas. La prueba está indicada en embarazadas con al menos 10 semanas de gestación, en las siguientes situaciones:
                </p>
                <ul class="plan-vida-p">
                    <li><span>Embarazo único o gemelar (2 fetos).</span></li>
                    <li><span>Embarazos por FIV.</span></li>
                    <li><span>Casos de ovodonación.</span></li>
                    <li><span>La prueba debe ser prescrita por un especialista.</span></li>
                </ul>`,
    orientation: 1,
    description_2: "",
  },
  {
    ...
    description_1: `<h3>Test Genético</h3>
                <p>
                    Analiza tu ADN, determinando si eres portador o no de alguna alteración en tus genes. El test analiza 176 enfermedades monogénicas seleccionadas por su gravedad y prevalencia, excluyendo las enfermedades sin relevancia clínica incluidas en otras pruebas.
