export const content = [
  ...
  },
  {
    ...
    <p>
      <strong>Colón.</strong> Detección precoz del cáncer de colon mediante un
      análisis de sangre.
      <br />
      <strong>Biopsia líquida</strong> mediante secuenciación para tumores
      sólidos en estadios avanzados (73 genes).
    </p>
    <ul class="plan-vida-p">
      <li>
        <span>
          Análisis dirigido de mutaciones tumorales en sangre (3 genes).
        </span>
      </li>
      <li>
        <span>Detección del cáncer de próstata.</span>
      </li>
    </ul>
    <p>
      <strong>Test Onco Farmacogenética</strong> del tratamiento con
    </p>
    <ul class="plan-vida-p">
      <li>
        <span>5 fluorouracilo (capecitabina).</span>
      </li>
      <li>
      ...
      <li>
        <span>Metrotrexato.</span>
      </li>
      <li>
        <span>Tamoxifeno.</span>
      </li>
      <li>
        <span>Tiopurinas.</span>
      </li>
      <li>
  ...
  },
  {
    ...
    <h3>Test Prenatal</h3>
    <p>
      Analiza el ADN libre fetal presente en la sangre materna para
      determinar el riesgo de que el feto sea portador de las anomalías
      cromosómicas estudiadas. La prueba está indicada en embarazadas con
      al menos 10 semanas de gestación, en las siguientes situaciones:
    </p>
    <ul class="plan-vida-p">
      ...
      <li>
        <span>La prueba debe ser prescrita por un especialista.</span>
      </li>
    </ul>`,
  },
  {
    ...
    <h3>Test Genético</h3>
    <p>
      Analiza tu ADN, determinando si eres portador o no de alguna alteración en
      tus genes. El test analiza 176 enfermedades monogénicas seleccionadas por
      su gravedad y prevalencia, excluyendo las enfermedades sin relevancia
      clínica incluidas en otras pruebas. Si ambos progenitores sois portadores
      de la misma enfermedad, se debe acudir a un especialista para recibir un
