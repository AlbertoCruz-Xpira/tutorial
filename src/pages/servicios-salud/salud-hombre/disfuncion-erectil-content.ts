...
export const content: BaseContent[] = [
  {
    ...
    description_1: `
      <p>
          Es la incapacidad para conseguir una erección o mantenerla con la
          suficiente firmeza para tener una relación sexual. El médico de
          cabecera es la persona indicada para consultar primero cuando tienes
          problemas eréctiles. Consulta con el médico en los siguientes casos:
        </p>
        <p>
          Te preocupan tus erecciones o tienes otros problemas sexuales, como
          eyaculación precoz o tardía
        </p>
        <p>
          Tienes diabetes, enfermedad cardíaca u otro trastorno conocido que
          pueda estar asociado con la disfunción eréctil
        </p>
        <p>Tienes otros síntomas además de la disfunción eréctil</p>
    `,
    orientation: 0,
    description_2: "",
  },
   {
    ...
    description_1: `
        <h3>
            Causas físicas de la disfunción eréctil: Algunas de las causas más
            frecuentes son:
          </h3>
          <p>Algunas de las causas más frecuentes son:</p>
          <br />
          <ul>
            <li>
            ...
            <li>
              <span> Vasos sanguíneos obstruidos (ateroesclerosis) </span>
            </li>
            <li>
              <span> Nivel de colesterol alto </span>
            </li>
            <li>
            ...
            <li>
              <span> Enfermedad de Parkinson </span>
            </li>
            <li>
              <span> Esclerosis múltiple </span>
            </li>
            <li>
              <span> Determinados medicamentos con receta </span>
            </li>
            <li>
            ...
            <li>
              <span> Abuso de alcohol y de otras sustancias </span>
            </li>
            <li>
            ...
            <li>
              <span>
                Tratamientos contra el cáncer de próstata o el agrandamiento de
                la próstata
              </span>
            </li>
            <li>
  ...
  },
   {
    ...
    description_1: `
        <h3>Causas psicológicas de la disfunción eréctil:</h3>
          <p>
            El cerebro cumple una función clave en la activación de los sucesos
            físicos. Varias cosas pueden interferir en los sentimientos sexuales
            y provocar o empeorar la disfunción eréctil:
          </p>
          <br />
          <ul>
            <li>
  ...
  },
   {
    ...
    description_1: `
        ...
        <ul>
          ...
          <li>
            <span>
              El consumo de tabaco, que limita el flujo de sangre a las venas y
              arterias, con el tiempo, provoca enfermedades crónicas que generan
              disfunción eréctil
            </span>
          </li>
          <li>
            <span> Tener sobrepeso, especialmente si eres obeso </span>
          </li>
          <li>
            <span>
              Determinados tratamientos médicos, como cirugía de próstata o
              radioterapia contra el cáncer
            </span>
          </li>
          <li>
            <span>
              Lesiones, en particular si estas dañan los nervios o las arterias
              que controlan las erecciones
            </span>
          </li>
          <li>
            <span>
              Medicamentos, como antidepresivos, antihistamínicos y medicamentos
              para tratar la presión arterial alta, el dolor o las enfermedades
              de la próstata
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              Consumo de alcohol y de drogas, en especial si consumes drogas o
              bebes mucho desde hace tiempo.
            </span>
          </li>
        </ul>
    `,
  ...
  },
  {
    ...
    description_1: `<p>
          ...
          satisfacción seguramente aumentará la libido. Además, ayuda a
          disfrutar más en la cama, los más avalados Natación y Pilates.
        </p>`,
    orientation: 0,
    description_2: "",
  },
  ...
  },
  {
    ...
    description_1: `<p>
          ...
          alimentos nos ayudan a mejorar la cantidad y calidad seminal.
        </p>`,
    orientation: 0,
    description_2: "",
  },
...

  {
    ...
    description_1: `<p>
          ...
          producen descenso en la producción de testosterona
        </p>`,
    orientation: 0,
    description_2: ``,
  },
  {
    ...
    description_1: `<p>
          ...
          prejuicios y evitar las que influyen de forma negativa. En una
          relación sana, el placer, la ternura y los afectos, se comparten.
        </p>`,
    orientation: 0,
    description_2: ``,
  },
  {
    ...
    description_1: `<p>
          ...
          practicas de riesgo y métodos para evitar esos riesgos. Informar sobre
          relaciones sanas.
        </p>`,
    orientation: 0,
    description_2: "",
  },
  {
    ...
    description_1: `<p>
          ...
          sexuales sanas y satisfactorias, con el consentimiento para lograr un
          encuentro erótico de calidad.
        </p>`,
    orientation: 0,
    description_2: "",
  }
