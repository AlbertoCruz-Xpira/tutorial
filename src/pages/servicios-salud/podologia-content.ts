...
export const content: BaseContent[] = [
  {
    ...
    description_1: `<p>
              ...
              el pie y las uñas. Un mal apoyo de los pies, un calzado
              inadecuado, infecciones víricas fúngicas o bacterianas pueden
  ...
  },
  {
    ...
    description_1: `<p>
              ...
              desplazamiento de las capas de la piel. Puede estar relacionado
              con una presión externa como puede ser el zapato o una presión
              interna por ejemplo un dedo deformado. Este engrosamiento de la
              piel puede producir molestias y puede ir acompañado de otras
              lesiones de mayor dureza.
              <br />
              Tipos:
            </p>
            <ul>
              <li>
                <span> Los helomas o callos. </span>
              </li>
              <li>
                <span> Papilomas (Verrugas). </span>
              </li>
            </ul>`,
    orientation: 0,
    description_2: "",
  },
  {
    ...
    description_1: `
          ...
          <p>
            El factor traumático es el desencadenante de una uña encarnada. La
            presión directa sobre la uña bien desde el dorso o bien desde los
  ...
  },
  {
    ...
    description_1: `<p>Existen algunos problemas de los pies que se pueden resolver de manera definitiva mediante cirugía.</p>
                ...
                <p>El factor traumático es el desencadenante de una uña encarnada. La presión directa sobre la uña bien desde el dorso o bien desde los laterales produce que se clave la uña en la piel de los bordes del dedo.</p>`,
    orientation: 0,
    description_2: "",
  },
  {
    ...
    description_1: `<h3>Juanetes</h3>
      <p>
        El origen de los juanetes en mayor parte de los casos suele producirse
        por cambios biomecánicos del pie. También existe un componente genético
        hereditario que predisponen a que el pie de deforme hacia los juanetes,
        los pacientes heredan la forma de los dedos y de los pies en general. Se
        usan medidas conservadoras como plantillas o cambios de calzado cuya
        finalidad es mejorar los síntomas, pero no corrigen la deformidad. La
        única solución definitiva es la cirugía.
      </p>
      <h3>Metatarsalgia</h3>
      <p>
  ...
  },
  {
    ...
    description_1: `<p>
            ...
            transportarnos. Los pies han soportado muchos pasos y el peso del
            cuerpo. Es por ello por lo que la edad produce una serie de cambios
            en la piel y en las uñas que se tiene que cuidar.
          </p>
          <br />
          <p>
            La grasa de la planta del pie puede modificar su propiedad de
            amortiguación y a su vez tener también deshidratación lo que provoca
            que se produzcan más lesiones. Las uñas también sufren cambios en su
            estructura y en su grosor.
          </p>`,
    orientation: 0,
    description_2: "",
  },
